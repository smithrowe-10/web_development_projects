  ...
  return(
    <Modal open={open} onClose={handleClose}>
      ...
      >
        ...
        <Typography variant="h5" align="center" sx={{color: '#5B2386', mb:3}}>당신의 꿈을 응원합니다!</Typography>
        ...
        <Typography variant="caption" display='block' align="center" color="gray">(그냥 닫기 버튼입니다.)</Typography>
      </Box>
    </Modal>
